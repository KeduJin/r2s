...
accelerate launch \
  ...
  --config configs/train/qwen-esm2_35M-qwen3ca_100M-weighting1_1-plddt_filter.yaml 2>&1 | tee \
  output/SlurmLogs/qwen-esm2_35M-qwen3ca_100M-weighting1_1-plddt_filter.log
