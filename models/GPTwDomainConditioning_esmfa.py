...
from transformers import EsmTokenizer, GenerationConfig, GPT2Config, GPT2LMHeadModel

from utils.init_utils import construct_class_by_name
from utils.metrics import Scalar

# from byprot.models.utils import sample_from_categorical, stochastic_sample_from_categorical, top_k_top_p_filtering
from .BaseModel import BaseModel
from .ModifiedESM.modeling_modified_faesm import ModifiedEsmModel as ModifiedEsmModel


class GPTwDomainConditioning_esmfa(BaseModel):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.esm_encoder = ModifiedEsmModel.from_pretrained(
            esm_type, _attn_implementation="flash_attention_2"
        )
        ...
        # cast the model to bf16
        # self.to(torch.bfloat16) # since flash attention 2 only supports bf16
...
if __name__ == "__main__":
    ...
    model = GPTwDomainConditioning_esmfa(logger=logger)
    model.to("cuda")
    model.eval()
