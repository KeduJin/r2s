...
from .ModifiedESM.modeling_modified_sdpaesm import ModifiedEsmModel as ModifiedEsmModel


class GPTwDomainConditioning_esmsdpa(BaseModel):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.esm_encoder = ModifiedEsmModel.from_pretrained(esm_type)
