...
class DPLMUnconditional_wo_lossmask(BaseModel):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.logger.info(
            f"DPLMUnconditional_wo_lossmask initialized with dplm_type: {dplm_type}"
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        return {
            "logits": logits,
            "target": target,
            "loss_mask": None,  ## loss_mask is not used!!!
            "weight": weight,
            "loss": loss,
            **logging_output,
        }
