...
class Qwen3CAwReactionMATConditioning(BaseModel):
    def __init__(
        self,
    ...
    def forward_encoder(
        ...
        reaction_tokens = self.reaction_token_encoder(reaction_tokens)
    ...
    def _forward(
        ...
        **kwargs,
        ...
        return self.qwen3(
            input_ids=seq_ids,
            encoder_hidden_states=reaction_tokens,
            encoder_attention_mask=reaction_mask,
            labels=labels,
